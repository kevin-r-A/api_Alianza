...
public partial class HVALLESEntities : DbContext
{
    public HVALLESEntities()
        : base("name=HVALLESEntities")
    {
    ...
    public virtual DbSet<ACRESERVA> ACRESERVAs { get; set; }
    ...
    public virtual DbSet<CFAMILIA> CFAMILIAs { get; set; }

    public virtual DbSet<CODIGO> CODIGOes { get; set; }

    public virtual DbSet<CODIGOMASIVO> CODIGOMASIVOes { get; set; }

    public virtual DbSet<COLOR> COLORs { get; set; }

    public virtual DbSet<CUSTODIO> CUSTODIOs { get; set; }

    public virtual DbSet<DEPRECIACION> DEPRECIACIONs { get; set; }

    public virtual DbSet<DEPRECIACIONSRI> DEPRECIACIONSRIs { get; set; }

    public virtual DbSet<DGENERADA> DGENERADAs { get; set; }

    public virtual DbSet<DGENERADASRI> DGENERADASRIs { get; set; }

    public virtual DbSet<EMPRESA> EMPRESAs { get; set; }

    public virtual DbSet<ESTADO> ESTADOes { get; set; }

    public virtual DbSet<ESTRUCOMP> ESTRUCOMPs { get; set; }

    public virtual DbSet<GRUPO> GRUPOes { get; set; }

    public virtual DbSet<GRUPOSRI> GRUPOSRIs { get; set; }

    public virtual DbSet<HCODIGO> HCODIGOes { get; set; }

    public virtual DbSet<HISTORIAL_PASSWORD> HISTORIAL_PASSWORD { get; set; }

    public virtual DbSet<HUCUSTODIO> HUCUSTODIOs { get; set; }

    public virtual DbSet<INVALIDCREDENTIALSLOG> INVALIDCREDENTIALSLOGs { get; set; }

    public virtual DbSet<MACTIVO> MACTIVOes { get; set; }
    ...
    public virtual DbSet<ROLPPC> ROLPPCs { get; set; }

    public virtual DbSet<TIPO_SEGURO> TIPO_SEGURO { get; set; }

    public virtual DbSet<TIPOMAN> TIPOMen { get; set; }

    public virtual DbSet<UGEOGRAFICA> UGEOGRAFICAs { get; set; }

    public virtual DbSet<UNIDAD> UNIDADs { get; set; }

    public virtual DbSet<UORGANICA> UORGANICAs { get; set; }

    public virtual DbSet<USUPPC> USUPPCs { get; set; }

    public virtual DbSet<XCUOR> XCUORs { get; set; }

    public virtual DbSet<HFOTO> HFOTOes { get; set; }

    public virtual DbSet<ACTIVO> ACTIVOes { get; set; }

    public virtual DbSet<Cabecera> Cabeceras { get; set; }

    public virtual DbSet<DetalleModulo> DetalleModuloes { get; set; }
    ...
    public virtual ObjectResult<ACTIVOPC05_Result> ACTIVOPC05(Nullable<int> aCT_ID)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ACTIVOPC05_Result>("ACTIVOPC05", aCT_IDParameter);
    }


    public virtual ObjectResult<ArranqueMantCorrectivo_Result> ArranqueMantCorrectivo(Nullable<int> codigo)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ArranqueMantCorrectivo_Result>("ArranqueMantCorrectivo", codigoParameter);
    }


    public virtual ObjectResult<ArranqueMantPreventivo_Result> ArranqueMantPreventivo(Nullable<int> codigo)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ArranqueMantPreventivo_Result>("ArranqueMantPreventivo", codigoParameter);
    }
    ...
    public virtual ObjectResult<CORREOS_USUMANTENIMIENTO_Result> CORREOS_USUMANTENIMIENTO()
    {

        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<CORREOS_USUMANTENIMIENTO_Result>("CORREOS_USUMANTENIMIENTO");
    }
    ...
    public virtual ObjectResult<ENVIA_MANTENIMIENTOSAUTO_Result> ENVIA_MANTENIMIENTOSAUTO()
    {

        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ENVIA_MANTENIMIENTOSAUTO_Result>("ENVIA_MANTENIMIENTOSAUTO");
    }
    ...
    public virtual ObjectResult<MANTENIMIENTOPC01_Result> MANTENIMIENTOPC01(string cODIGO, string sERIE, Nullable<int> oP)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<MANTENIMIENTOPC01_Result>("MANTENIMIENTOPC01", cODIGOParameter, sERIEParameter, oPParameter);
    }


    public virtual ObjectResult<MANTENIMIENTOPC03_Result> MANTENIMIENTOPC03(string act_codbarras, string act_serie1, Nullable<int> oP)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<MANTENIMIENTOPC03_Result>("MANTENIMIENTOPC03", act_codbarrasParameter, act_serie1Parameter, oPParameter);
    }


    public virtual ObjectResult<MANTENIMIENTOPC05_Result> MANTENIMIENTOPC05(Nullable<int> oP, string cODIGOBARRAS, string sERIE, Nullable<int> mARCA, Nullable<int> mODELO)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<MANTENIMIENTOPC05_Result>("MANTENIMIENTOPC05", oPParameter, cODIGOBARRASParameter, sERIEParameter, mARCAParameter, mODELOParameter);
    }


    public virtual int MANTENIMIENTOPI01(string mAN_DESCRIPCION, Nullable<int> tIP_ID_CORRECTIVO, Nullable<int> tIP_ID_PREVENTIVO, string uSERNAME, Nullable<System.DateTime> mAN_FECHA, Nullable<int> aCT_ID, Nullable<bool> mAN_REALIZADO, Nullable<System.DateTime> mAN_FECHAPROXINI, Nullable<decimal> mAN_VALOR, string mAN_NUMDOC, string mAN_FORMA, Nullable<int> mAN_COBERTURA, string mAN_MODALIDAD, string mAN_PORMESES, string mAN_ESTADO, Nullable<System.DateTime> mAN_FECHAPROXFIN, Nullable<System.DateTime> mAN_FECHAREALMANT, string aCT_ESTADOMANT, Nullable<System.DateTime> aCT_FECHAENVIOMANT, Nullable<System.DateTime> aCT_FECHAREGRESOMANT, ObjectParameter err)
    {
        ...
        var tIP_ID_CORRECTIVOParameter = tIP_ID_CORRECTIVO.HasValue ?
            new ObjectParameter("TIP_ID_CORRECTIVO", tIP_ID_CORRECTIVO) :
            new ObjectParameter("TIP_ID_CORRECTIVO", typeof(int));


        var tIP_ID_PREVENTIVOParameter = tIP_ID_PREVENTIVO.HasValue ?
            new ObjectParameter("TIP_ID_PREVENTIVO", tIP_ID_PREVENTIVO) :
            new ObjectParameter("TIP_ID_PREVENTIVO", typeof(int));
        ...
        var mAN_FECHAPROXINIParameter = mAN_FECHAPROXINI.HasValue ?
            new ObjectParameter("MAN_FECHAPROXINI", mAN_FECHAPROXINI) :
            new ObjectParameter("MAN_FECHAPROXINI", typeof(System.DateTime));


        var mAN_VALORParameter = mAN_VALOR.HasValue ?
            new ObjectParameter("MAN_VALOR", mAN_VALOR) :
            new ObjectParameter("MAN_VALOR", typeof(decimal));


        var mAN_NUMDOCParameter = mAN_NUMDOC != null ?
            new ObjectParameter("MAN_NUMDOC", mAN_NUMDOC) :
            new ObjectParameter("MAN_NUMDOC", typeof(string));


        var mAN_FORMAParameter = mAN_FORMA != null ?
            new ObjectParameter("MAN_FORMA", mAN_FORMA) :
            new ObjectParameter("MAN_FORMA", typeof(string));


        var mAN_COBERTURAParameter = mAN_COBERTURA.HasValue ?
            new ObjectParameter("MAN_COBERTURA", mAN_COBERTURA) :
            new ObjectParameter("MAN_COBERTURA", typeof(int));


        var mAN_MODALIDADParameter = mAN_MODALIDAD != null ?
            new ObjectParameter("MAN_MODALIDAD", mAN_MODALIDAD) :
            new ObjectParameter("MAN_MODALIDAD", typeof(string));


        var mAN_PORMESESParameter = mAN_PORMESES != null ?
            new ObjectParameter("MAN_PORMESES", mAN_PORMESES) :
            new ObjectParameter("MAN_PORMESES", typeof(string));


        var mAN_ESTADOParameter = mAN_ESTADO != null ?
            new ObjectParameter("MAN_ESTADO", mAN_ESTADO) :
            new ObjectParameter("MAN_ESTADO", typeof(string));


        var mAN_FECHAPROXFINParameter = mAN_FECHAPROXFIN.HasValue ?
            new ObjectParameter("MAN_FECHAPROXFIN", mAN_FECHAPROXFIN) :
            new ObjectParameter("MAN_FECHAPROXFIN", typeof(System.DateTime));


        var mAN_FECHAREALMANTParameter = mAN_FECHAREALMANT.HasValue ?
            new ObjectParameter("MAN_FECHAREALMANT", mAN_FECHAREALMANT) :
            new ObjectParameter("MAN_FECHAREALMANT", typeof(System.DateTime));


        var aCT_ESTADOMANTParameter = aCT_ESTADOMANT != null ?
            new ObjectParameter("ACT_ESTADOMANT", aCT_ESTADOMANT) :
            new ObjectParameter("ACT_ESTADOMANT", typeof(string));


        var aCT_FECHAENVIOMANTParameter = aCT_FECHAENVIOMANT.HasValue ?
            new ObjectParameter("ACT_FECHAENVIOMANT", aCT_FECHAENVIOMANT) :
            new ObjectParameter("ACT_FECHAENVIOMANT", typeof(System.DateTime));


        var aCT_FECHAREGRESOMANTParameter = aCT_FECHAREGRESOMANT.HasValue ?
            new ObjectParameter("ACT_FECHAREGRESOMANT", aCT_FECHAREGRESOMANT) :
            new ObjectParameter("ACT_FECHAREGRESOMANT", typeof(System.DateTime));


        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("MANTENIMIENTOPI01", mAN_DESCRIPCIONParameter, tIP_ID_CORRECTIVOParameter, tIP_ID_PREVENTIVOParameter, uSERNAMEParameter, mAN_FECHAParameter, aCT_IDParameter, mAN_REALIZADOParameter, mAN_FECHAPROXINIParameter, mAN_VALORParameter, mAN_NUMDOCParameter, mAN_FORMAParameter, mAN_COBERTURAParameter, mAN_MODALIDADParameter, mAN_PORMESESParameter, mAN_ESTADOParameter, mAN_FECHAPROXFINParameter, mAN_FECHAREALMANTParameter, aCT_ESTADOMANTParameter, aCT_FECHAENVIOMANTParameter, aCT_FECHAREGRESOMANTParameter, err);
    }


    public virtual int MANTENIMIENTOPI02(string mAN_DESCRIPCION, Nullable<int> tIP_ID_CORRECTIVO, Nullable<int> tIP_ID_PREVENTIVO, string uSERNAME, Nullable<System.DateTime> mAN_FECHA, Nullable<int> aCT_ID, Nullable<bool> mAN_REALIZADO, Nullable<System.DateTime> mAN_FECHAPROXINI, Nullable<decimal> mAN_VALOR, string mAN_NUMDOC, string mAN_FORMA, Nullable<int> mAN_COBERTURA, string mAN_MODALIDAD, string mAN_PORMESES, string mAN_ESTADO, Nullable<System.DateTime> mAN_FECHAPROXFIN, Nullable<System.DateTime> mAN_FECHAREALMANT, ObjectParameter err)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("MANTENIMIENTOPI02", mAN_DESCRIPCIONParameter, tIP_ID_CORRECTIVOParameter, tIP_ID_PREVENTIVOParameter, uSERNAMEParameter, mAN_FECHAParameter, aCT_IDParameter, mAN_REALIZADOParameter, mAN_FECHAPROXINIParameter, mAN_VALORParameter, mAN_NUMDOCParameter, mAN_FORMAParameter, mAN_COBERTURAParameter, mAN_MODALIDADParameter, mAN_PORMESESParameter, mAN_ESTADOParameter, mAN_FECHAPROXFINParameter, mAN_FECHAREALMANTParameter, err);
    }
    ...
    public virtual int SP_VERIFICA_BLOQUEO()
    {

        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_VERIFICA_BLOQUEO");
    }
    ...
    public virtual ObjectResult<usp_ArranqueMantenimientos_Result> usp_ArranqueMantenimientos(Nullable<int> codigo)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_ArranqueMantenimientos_Result>("usp_ArranqueMantenimientos", codigoParameter);
    }
    ...
    public virtual int usp_CambiaEstadoMantActivo(string codbarras, string username, string estado, Nullable<int> op, Nullable<int> act_cod, ObjectParameter err)
    {
        ...
        var act_codParameter = act_cod.HasValue ?
            new ObjectParameter("act_cod", act_cod) :
            new ObjectParameter("act_cod", typeof(int));


        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_CambiaEstadoMantActivo", codbarrasParameter, usernameParameter, estadoParameter, opParameter, act_codParameter, err);
    }
    ...
    public virtual int usp_IngresaDeMantenimiento(string where)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_IngresaDeMantenimiento", whereParameter);
    }
    ...
    public virtual ObjectResult<usp_ReporteHistoricoMantenimiento_Result> usp_ReporteHistoricoMantenimiento(string codbarras, Nullable<int> op)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_ReporteHistoricoMantenimiento_Result>("usp_ReporteHistoricoMantenimiento", codbarrasParameter, opParameter);
    }
